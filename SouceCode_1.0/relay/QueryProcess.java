...
public class QueryProcess{
	...
	public static final String DNS_IP = "10.96.1.19";
	...
	void packetHandler() throws Exception{
		...
		if(IPTable.containsKey(domainName)){
			...
			if(ip.equals("0.0.0.0")){
				//System.out.println("The address not exist! "+ "Line: 49" + df.format(new Date()));
				//byte[] sendData = r.createResponse();
				...
				System.out.println("The address exist! IP is: "+ ip +"Line: 60" + df.format(new Date()));
				//byte[] sendData = r.createResponse();
				sendData[2] = (byte) (sendData[2] | 0x81); 
