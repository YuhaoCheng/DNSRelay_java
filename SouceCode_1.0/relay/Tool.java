...
public class Tool {
	...
	public Map loadIPTable() throws Exception{
        ...
        Map<String,String> IPTable = new HashMap<String,String>(); //Map<domian,ip>
		...
		while(input.hasNext()){
			...
			System.out.println("The domain name is:"+domainName + " The IP:"+IPTable.get(domainName));
			//System.out.println();
			//System.out.println(ip);
			//System.out.println(index);
			//System.out.println(line);
		}
		System.out.println("The tabel dnsrelay.txt is successful loaded: " + df.format(new Date()));
	    return IPTable;
	}
